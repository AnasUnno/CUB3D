...
SRCS		=	cub3d.c Map2D/map2d.c Map2D/set_window.c Map2D/set_player.c Chapes/rect.c Chapes/circle.c Chapes/line.c hooks/hooks.c hooks/esc.c hooks/left_right.c hooks/up_down.c hooks/rotation.c hooks/player_collision.c\
				Parser/parsing.c Parser/utils.c Parser/get_next_line.c Parser/ft_split.c Parser/parsing2.c Parser/parsing3.c Parser/libft.c Parser/parsing4.c Parser/parsing5.c Parser/map_err.c Parser/ft_split_set.c\
				...
				textures/textures.c textures/check_textures.c textures/paint_sprite.c 
OBJS		= $(SRCS:.c=.o)
